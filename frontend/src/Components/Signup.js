...
export class Signup extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <p className="text-center h2 my-4">Signup</p>
                <div style={{ width: "50%", margin: "0 auto" }}>
                    ...
                    <div className="input-group mb-3">
                        ...
                        <input type="password" className="form-control" name="password2" onChange={this.handleChangeInput("password2")} aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" />

                    </div>
                    {errors.password2 ? (
                        <div style={{ color: "red" }} className="mb-4">{this.state.errors.password2}</div>
                    ) : null}
                    <button className="btn btn-primary" onClick={() => this.onClick()}>Signup</button>
                </div>
            </div>
        )
    }
